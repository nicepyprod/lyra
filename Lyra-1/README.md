...
> **Personal note:** I tested installation on Ubuntu 22.04 with CUDA 12.1 and Python 3.10 — worked smoothly following the instructions as written. The conda environment setup took ~15 minutes on first run.
